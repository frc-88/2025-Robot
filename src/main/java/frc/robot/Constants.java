...
public final class Constants {
    ...
    public static final Pose2d REEF_POSE = new Pose2d(
    ...
    public static final Map<Integer, Pose2d> REEF_CORAL_POSES_BLUE = Map.ofEntries(
    ...
    public static final Map<Integer, Pose2d> REEF_CORAL_POSES_RED = Map.ofEntries(
            Map.entry(1, new Pose2d(5.427, 3.028, new Rotation2d(Units.degreesToRadians(120.0)))),
            Map.entry(2, new Pose2d(5.168, 2.878, new Rotation2d(Units.degreesToRadians(120.0)))),
            Map.entry(3, new Pose2d(4.133, 2.713, new Rotation2d(Units.degreesToRadians(60.0)))),
            Map.entry(4, new Pose2d(3.837, 2.860, new Rotation2d(Units.degreesToRadians(60.0)))),
    ...
    public static Pose2d SECTOR2ALGAE = new Pose2d(3.892, 2.778, new Rotation2d(Units.degreesToRadians(60.0)));
    public static Pose2d SECTOR6ALGAE = new Pose2d(5.7825, 4.16, new Rotation2d(Units.degreesToRadians(180.0)));
    public static Pose2d SECTOR1ALGAE = new Pose2d(5.298, 3.0225, new Rotation2d(Units.degreesToRadians(120.0)));
    public static Pose2d SECTOR5ALGAE = new Pose2d(5.002, 5.255, new Rotation2d(Units.degreesToRadians(-120.0)));
    public static Pose2d SECTOR4ALGAE = new Pose2d(3.716, 5.0605, new Rotation2d(Units.degreesToRadians(-60.0)));
